    ...
    <>
      ...
      <div className="flex flex-wrap gap-4 p-4">
        ...
        <div className="flex min-w-[158px] flex-1 flex-col gap-2 rounded-xl p-6 bg-[#eaedf1]">
          ...
          <p className="text-[#101418] tracking-light text-2xl font-bold leading-tight">{convertUSDToNaira(750000)}</p>
          ...
          <table className="flex-1">
            ...
            <tbody>
              <tr className="border-t border-t-[#d4dbe2]">
                ...
                <td className="h-[72px] px-4 py-2 w-[400px] text-[#5c738a] text-sm font-normal leading-normal">{convertUSDToNaira(35000)}</td>
              ...
              <tr className="border-t border-t-[#d4dbe2]">
                ...
                <td className="h-[72px] px-4 py-2 w-[400px] text-[#5c738a] text-sm font-normal leading-normal">{convertUSDToNaira(28000)}</td>
                <td className="h-[72px] px-4 py-2 w-[400px] text-sm font-normal leading-normal">
                  <div className="flex items-center gap-3">
              ...
              <tr className="border-t border-t-[#d4dbe2]">
                ...
                <td className="h-[72px] px-4 py-2 w-[400px] text-[#5c738a] text-sm font-normal leading-normal">{convertUSDToNaira(22000)}</td>
                <td className="h-[72px] px-4 py-2 w-[400px] text-sm font-normal leading-normal">
                  <div className="flex items-center gap-3">
              ...
              <tr className="border-t border-t-[#d4dbe2]">
                ...
                <td className="h-[72px] px-4 py-2 w-[400px] text-[#5c738a] text-sm font-normal leading-normal">{convertUSDToNaira(18000)}</td>
                <td className="h-[72px] px-4 py-2 w-[400px] text-sm font-normal leading-normal">
                  <div className="flex items-center gap-3">
                    <div className="w-[88px] overflow-hidden rounded-sm bg-[#d4dbe2]"><div className="h-1 rounded-full bg-[#3f7fbf]" style={{width: '100%'}}></div></div>
              ...
              <tr className="border-t border-t-[#d4dbe2]">
                ...
                <td className="h-[72px] px-4 py-2 w-[400px] text-[#5c738a] text-sm font-normal leading-normal">{convertUSDToNaira(15000)}</td>
                <td className="h-[72px] px-4 py-2 w-[400px] text-sm font-normal leading-normal">
                  <div className="flex items-center gap-3">
      ...
      <div className="flex flex-wrap gap-4 px-4 py-6">
        ...
        <div className="flex min-w-72 flex-1 flex-col gap-2 rounded-xl border border-[#d4dbe2] p-6">
          ...
          <p className="text-[#101418] tracking-light text-[32px] font-bold leading-tight truncate">{convertUSDToNaira(2500000)}</p>
          <div className="flex gap-1">
