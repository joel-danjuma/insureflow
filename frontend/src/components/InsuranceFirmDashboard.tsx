    ...
    <>
      <div className="flex flex-wrap justify-between gap-3 p-4">
        <div className="flex min-w-72 flex-col gap-3">
          <p className="text-text-primary tracking-light text-[32px] font-bold leading-tight">Dashboard</p>
      ...
      <div className="flex flex-wrap gap-4 p-4">
        <div className="flex min-w-[158px] flex-1 flex-col gap-2 rounded-xl p-6 bg-bg-tertiary">
          <p className="text-text-primary text-base font-medium leading-normal">New Policies</p>
          <p className="text-text-primary tracking-light text-2xl font-bold leading-tight">1,250</p>
          <p className="text-accent-orange text-base font-medium leading-normal">+15%</p>
        </div>
        <div className="flex min-w-[158px] flex-1 flex-col gap-2 rounded-xl p-6 bg-bg-tertiary">
          <p className="text-text-primary text-base font-medium leading-normal">Outstanding Premiums</p>
        ...
        <div className="flex min-w-[158px] flex-1 flex-col gap-2 rounded-xl p-6 bg-bg-tertiary">
          <p className="text-text-primary text-base font-medium leading-normal">Broker Performance</p>
        ...
        <div className="flex min-w-[158px] flex-1 flex-col gap-2 rounded-xl p-6 bg-bg-tertiary">
          <p className="text-text-primary text-base font-medium leading-normal">Claims Processed</p>
          <p className="text-text-primary tracking-light text-2xl font-bold leading-tight">320</p>
          <p className="text-accent-orange text-base font-medium leading-normal">+8%</p>
        </div>
      </div>
      <h2 className="text-text-primary text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">Broker Information</h2>
      <div className="px-4 py-3 @container">
        <div className="flex overflow-hidden rounded-xl border border-border-color bg-bg-secondary">
          <table className="flex-1">
            <thead>
              <tr className="bg-bg-secondary">
                <th className="px-4 py-3 text-left text-text-primary w-[400px] text-sm font-medium leading-normal">Broker Name</th>
                <th className="px-4 py-3 text-left text-text-primary w-[400px] text-sm font-medium leading-normal">Policies Sold</th>
                <th className="px-4 py-3 text-left text-text-primary w-[400px] text-sm font-medium leading-normal">Commission Earned</th>
                <th className="px-4 py-3 text-left text-text-primary w-[400px] text-sm font-medium leading-normal">Client Satisfaction</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-t border-t-border-color">
                ...
                <td className="h-[72px] px-4 py-2 w-[400px] text-sm font-normal leading-normal">
                  <div className="flex items-center gap-3">
                    <div className="w-[88px] overflow-hidden rounded-sm bg-border-color"><div className="h-1 rounded-full bg-accent-orange" style={{width: '96.5909%'}}></div></div>
              ...
              <tr className="border-t border-t-border-color">
                ...
                <td className="h-[72px] px-4 py-2 w-[400px] text-sm font-normal leading-normal">
                  <div className="flex items-center gap-3">
                    <div className="w-[88px] overflow-hidden rounded-sm bg-border-color"><div className="h-1 rounded-full bg-accent-orange" style={{width: '100%'}}></div></div>
              ...
              <tr className="border-t border-t-border-color">
                ...
                <td className="h-[72px] px-4 py-2 w-[400px] text-sm font-normal leading-normal">
                  <div className="flex items-center gap-3">
                    <div className="w-[88px] overflow-hidden rounded-sm bg-border-color"><div className="h-1 rounded-full bg-accent-orange" style={{width: '88.6364%'}}></div></div>
              ...
              <tr className="border-t border-t-border-color">
                ...
                <td className="h-[72px] px-4 py-2 w-[400px] text-sm font-normal leading-normal">
                  <div className="flex items-center gap-3">
                    <div className="w-[88px] overflow-hidden rounded-sm bg-border-color"><div className="h-1 rounded-full bg-accent-orange" style={{width: '90.9091%'}}></div></div>
      ...
      <h2 className="text-text-primary text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">Claims Data</h2>
      <div className="flex flex-wrap gap-4 px-4 py-6">
        <div className="flex min-w-72 flex-1 flex-col gap-2 rounded-xl border border-border-color p-6 bg-bg-tertiary">
          <p className="text-text-primary text-base font-medium leading-normal">Claims Processed by Type</p>
        ...
        <div className="flex min-w-72 flex-1 flex-col gap-2 rounded-xl border border-border-color p-6 bg-bg-tertiary">
          <p className="text-text-primary text-base font-medium leading-normal">Claims Payout Over Time</p>
            ...
            <svg width="100%" height="148" viewBox="-3 0 478 150" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
              ...
              <defs>
                <linearGradient id="paint0_linear_1131_5935_insurance" x1="236" y1="1" x2="236" y2="149" gradientUnits="userSpaceOnUse">
                  <stop stopColor="var(--bg-secondary)"></stop>
