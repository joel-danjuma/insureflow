        ...
        <div className="flex h-full min-h-[700px] flex-col justify-between bg-gray-50 p-4">
          <div className="flex flex-col gap-4">
            <div className="flex flex-col">
              ...
              <p className="text-[#5c738a] text-sm font-normal leading-normal">Broker Team</p>
            </div>
            <div className="flex flex-col gap-2">
              <div className="flex items-center gap-3 px-3 py-2 rounded-full bg-[#eaedf1]">
              ...
              <div className="flex items-center gap-3 px-3 py-2">
                ...
                <p className="text-[#101418] text-sm font-medium leading-normal">Policies</p>
              </div>
              <div className="flex items-center gap-3 px-3 py-2">
                <div className="text-[#101418]">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                ...
                <p className="text-[#101418] text-sm font-medium leading-normal">Commissions</p>
              </div>
              <div className="flex items-center gap-3 px-3 py-2">
                <div className="text-[#101418]">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                ...
                <p className="text-[#101418] text-sm font-medium leading-normal">Support</p>
              </div>
            </div>
          </div>
        </div>
