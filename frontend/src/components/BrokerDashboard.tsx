  ...
  return (
    <div className="gap-1 px-6 flex flex-1 justify-center py-5">
      <div className="layout-content-container flex flex-col w-80">
        <div className="flex h-full min-h-[700px] flex-col justify-between bg-bg-secondary p-4">
          <div className="flex flex-col gap-4">
            <div className="flex flex-col">
              <h1 className="text-text-primary text-base font-medium leading-normal">Acme Co</h1>
              <p className="text-text-secondary text-sm font-normal leading-normal">Broker Team</p>
            </div>
            <div className="flex flex-col gap-2">
              <div className="flex items-center gap-3 px-3 py-2 rounded-full bg-accent-orange">
                <div className="text-bg-primary">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                    <path d="M224,115.55V208a16,16,0,0,1-16,16H168a16,16,0,0,1-16-16V168a8,8,0,0,0-8-8H112a8,8,0,0,0-8,8v40a16,16,0,0,1-16,16H48a16,16,0,0,1-16-16V115.55a16,16,0,0,1,5.17-11.78l80-75.48.11-.11a16,16,0,0,1,21.53,0,1.14,1.14,0,0,0,.11.11l80,75.48A16,16,0,0,1,224,115.55Z"></path>
                  </svg>
                </div>
                <p className="text-bg-primary text-sm font-medium leading-normal">Dashboard</p>
              </div>
              <div className="flex items-center gap-3 px-3 py-2 hover:bg-bg-tertiary rounded-full transition-colors">
                <div className="text-text-primary">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                    <path d="M117.25,157.92a60,60,0,1,0-66.5,0A95.83,95.83,0,0,0,3.53,195.63a8,8,0,1,0,13.4,8.74,80,80,0,0,1,134.14,0,8,8,0,0,0,13.4-8.74A95.83,95.83,0,0,0,117.25,157.92ZM40,108a44,44,0,1,1,44,44A44.05,44.05,0,0,1,40,108Zm210.14,98.7a8,8,0,0,1-11.07-2.33A79.83,79.83,0,0,0,172,168a8,8,0,0,1,0-16,44,44,0,1,0-16.34-84.87,8,8,0,1,1-5.94-14.85,60,60,0,0,1,55.53,105.64,95.83,95.83,0,0,1,47.22,37.71A8,8,0,0,1,250.14,206.7Z"></path>
                  </svg>
                </div>
                <p className="text-text-primary text-sm font-medium leading-normal">Clients</p>
              </div>
              <div className="flex items-center gap-3 px-3 py-2 hover:bg-bg-tertiary rounded-full transition-colors">
                <div className="text-text-primary">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                ...
                <p className="text-text-primary text-sm font-medium leading-normal">Policies</p>
              </div>
              <div className="flex items-center gap-3 px-3 py-2 hover:bg-bg-tertiary rounded-full transition-colors">
                <div className="text-text-primary">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                ...
                <p className="text-text-primary text-sm font-medium leading-normal">Commissions</p>
              </div>
              <div className="flex items-center gap-3 px-3 py-2 hover:bg-bg-tertiary rounded-full transition-colors">
                <div className="text-text-primary">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                ...
                <p className="text-text-primary text-sm font-medium leading-normal">Support</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
        <div className="flex flex-wrap justify-between gap-3 p-4">
          <div className="flex min-w-72 flex-col gap-3">
            <p className="text-text-primary tracking-light text-[32px] font-bold leading-tight">Broker Dashboard</p>
        ...
        <div className="flex flex-wrap gap-4 p-4">
          <div className="flex min-w-[158px] flex-1 flex-col gap-2 rounded-xl p-6 bg-bg-tertiary">
            <p className="text-text-primary text-base font-medium leading-normal">Total Sales</p>
            <p className="text-text-primary tracking-light text-2xl font-bold leading-tight">{convertUSDToNaira(250000)}</p>
            <p className="text-accent-orange text-base font-medium leading-normal">+10%</p>
          </div>
          <div className="flex min-w-[158px] flex-1 flex-col gap-2 rounded-xl p-6 bg-bg-tertiary">
            <p className="text-text-primary text-base font-medium leading-normal">Client Retention Rate</p>
          ...
          <div className="flex min-w-[158px] flex-1 flex-col gap-2 rounded-xl p-6 bg-bg-tertiary">
            <p className="text-text-primary text-base font-medium leading-normal">Average Commission</p>
            <p className="text-text-primary tracking-light text-2xl font-bold leading-tight">{convertUSDToNaira(5000)}</p>
            <p className="text-accent-orange text-base font-medium leading-normal">+5%</p>
          </div>
        </div>

        {/* Sales Performance Section */}
        <h2 className="text-text-primary text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">Sales Performance</h2>
        <div className="flex flex-wrap gap-4 px-4 py-6">
          {/* Sales Over Time Chart */}
          <div className="flex min-w-72 flex-1 flex-col gap-2 rounded-xl border border-border-color p-6 bg-bg-tertiary">
            <p className="text-text-primary text-base font-medium leading-normal">Sales Over Time</p>
              ...
              <svg width="100%" height="148" viewBox="-3 0 478 150" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
                ...
                <defs>
                  <linearGradient id="paint0_linear_1131_5935" x1="236" y1="1" x2="236" y2="149" gradientUnits="userSpaceOnUse">
                    <stop stopColor="var(--bg-secondary)" />
          ...
          <div className="flex min-w-72 flex-1 flex-col gap-2 rounded-xl border border-border-color p-6 bg-bg-tertiary">
            <p className="text-text-primary text-base font-medium leading-normal">Sales by Product</p>
        ...
        <h2 className="text-text-primary text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">Client Portfolio</h2>
        <div className="px-4 py-3 @container">
          <div className="flex overflow-hidden rounded-xl border border-border-color bg-bg-secondary">
            <table className="flex-1">
              <thead>
                <tr className="bg-bg-secondary">
                  <th className="px-4 py-3 text-left text-text-primary w-[400px] text-sm font-medium leading-normal">Client Name</th>
                  <th className="px-4 py-3 text-left text-text-primary w-[400px] text-sm font-medium leading-normal">Policy Type</th>
                  <th className="px-4 py-3 text-left text-text-primary w-60 text-sm font-medium leading-normal">Policy Status</th>
                  <th className="px-4 py-3 text-left text-text-primary w-[400px] text-sm font-medium leading-normal">Premium Amount</th>
                  <th className="px-4 py-3 text-left text-text-primary w-[400px] text-sm font-medium leading-normal">Next Payment Date</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-t border-t-border-color">
                  ...
                  <td className="h-[72px] px-4 py-2 w-60 text-sm font-normal leading-normal">
                    <button className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-8 px-4 bg-accent-orange text-bg-primary text-sm font-medium leading-normal w-full">
                ...
                <tr className="border-t border-t-border-color">
                  ...
                  <td className="h-[72px] px-4 py-2 w-60 text-sm font-normal leading-normal">
                    <button className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-8 px-4 bg-bg-tertiary text-text-primary text-sm font-medium leading-normal w-full">
